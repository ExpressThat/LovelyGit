...
- Where motion improves continuity, hierarchy, feedback, or spatial understanding, use polished and subtle animation that feels native to LovelyGit. Motion should explain a state change, preserve context, or acknowledge an interaction; keep the presentation static when animation would be decorative noise, repeat too frequently, or make the interface feel slower.

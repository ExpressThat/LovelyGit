...
internal sealed class GitRebaseCommandService
{
    private readonly GitCliService _gitCliService;

    public GitRebaseCommandService(GitCliService gitCliService)
    {
        _gitCliService = gitCliService;
    }

    public async Task RebaseCurrentBranchOntoBranchAsync(

...
namespace ExpressThat.LovelyGit.Services.NativeMessaging
{
    ...
    public enum NativeMessageType
    {
        ...
        [NativeMessageContract(typeof(RemoveKnownGitRepositorysCommandArguments), typeof(EmptyCommandArguments))]
        ...
        GetFileHistory,
        [NativeMessageContract(typeof(CancelFileHistoryCommandArguments))]
        CancelFileHistory,

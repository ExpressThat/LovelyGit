...
internal sealed class CreateBranchFromCommitCommandResolver
    : CommandResponder<CreateBranchFromCommitCommandArguments>
{
    ...
    protected override JsonTypeInfo<CreateBranchFromCommitCommandArguments> ArgumentsJsonTypeInfo =>
        BranchesJsonSerializerContext.Default.CreateBranchFromCommitCommandArguments;

    public CreateBranchFromCommitCommandResolver(
    ...
    {
        return command.CommandType == NativeMessageType.CreateBranchFromCommit;
    }

    public override async Task<CommandResponseBase> Resolve(
        NativeCommand<CreateBranchFromCommitCommandArguments> command)
    {

...
internal sealed class PullBranchCommandResolver
    : CommandResponder<PullBranchCommandArguments>
{
    ...
    protected override JsonTypeInfo<PullBranchCommandArguments> ArgumentsJsonTypeInfo =>
        BranchesJsonSerializerContext.Default.PullBranchCommandArguments;

    public PullBranchCommandResolver(
    ...
    {
        return command.CommandType == NativeMessageType.PullBranch;
    }

    public override async Task<CommandResponseBase> Resolve(
        NativeCommand<PullBranchCommandArguments> command)
    {
        ...
        try
        {
            await _branchCommandService.PullBranchAsync(
                foundRepo.Path,
    ...
    private static CommandResponseBase Success(NativeCommand<PullBranchCommandArguments> command)
    {

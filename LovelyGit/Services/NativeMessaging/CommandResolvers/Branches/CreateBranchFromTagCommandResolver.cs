...
internal sealed class CreateBranchFromTagCommandResolver
    : CommandResponder<CreateBranchFromTagCommandArguments>
{
    ...
    protected override JsonTypeInfo<CreateBranchFromTagCommandArguments> ArgumentsJsonTypeInfo =>
        BranchesJsonSerializerContext.Default.CreateBranchFromTagCommandArguments;

    public CreateBranchFromTagCommandResolver(
    ...
    {
        return command.CommandType == NativeMessageType.CreateBranchFromTag;
    }

    public override async Task<CommandResponseBase> Resolve(
        NativeCommand<CreateBranchFromTagCommandArguments> command)
    {
        ...
        try
        {
            await _branchCommandService.CreateBranchFromTagAsync(
                foundRepo.Path,

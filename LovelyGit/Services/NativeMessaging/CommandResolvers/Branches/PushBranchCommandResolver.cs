...
internal sealed class PushBranchCommandResolver
    : CommandResponder<PushBranchCommandArguments>
{
    ...
    {
        return command.CommandType == NativeMessageType.PushBranch;
    }
        ...
        NativeCommand<PushBranchCommandArguments> command)
    {
        ...
        try
        {
            await _branchCommandService.PushBranchAsync(
                foundRepo.Path,
    ...
    private static CommandResponseBase Success(NativeCommand<PushBranchCommandArguments> command)
    {

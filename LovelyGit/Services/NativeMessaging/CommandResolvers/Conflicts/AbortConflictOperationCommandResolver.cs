...
internal sealed class AbortConflictOperationCommandResolver
    : CommandResponder<CompleteConflictOperationCommandArguments>
{
    ...
    public AbortConflictOperationCommandResolver(
    ...
    public override bool CanRespondTo(NativeCommand<JsonElement> command) =>
        command.CommandType == NativeMessageType.AbortConflictOperation;
        ...
        NativeCommand<CompleteConflictOperationCommandArguments> command)
    {
        ...
        try
        {
            await _commandService.AbortAsync(path, CancellationToken.None);

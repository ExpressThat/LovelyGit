...
internal sealed class UnstageWorkingTreeFilesCommandResolver : CommandResponder<UpdateWorkingTreeIndexCommandArguments>
{
    ...
    protected override JsonTypeInfo<UpdateWorkingTreeIndexCommandArguments> ArgumentsJsonTypeInfo =>
        WorkingTreeJsonSerializerContext.Default.UpdateWorkingTreeIndexCommandArguments;

    public UnstageWorkingTreeFilesCommandResolver(
    ...
    {
        return command.CommandType == CommsHubCommandType.UnstageWorkingTreeFiles;
    }
    ...
    public override async Task<CommandResponseBase> Resolve(CommsHubCommand<UpdateWorkingTreeIndexCommandArguments> command)
    {
        ...
        try
        {
            await _workingTreeIndexService
                .UnstageAsync(foundRepo.Path, command.Arguments.Paths, command.Arguments.IncludeAll, CancellationToken.None)

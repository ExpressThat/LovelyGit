...
| Optimistic bulk unstage | 118.97 ms for 10,000 partially staged files due to repeated linear working-file lookup | 3.49 ms using one path index for the bulk mutation | Pure frontend large-list benchmark; 97.07% lower synchronous interaction latency with a 50 ms regression budget | This commit |

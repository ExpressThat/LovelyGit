...
| Native repository loose-ref load | 625.47 ms and 22.44 MB allocated for five cold-cache loads of 500 loose refs | 615.16 ms and 2.68 MB allocated; shares the stack-buffer reader with repository-ref refresh | Isolated disposable multi-directory benchmark; latency effectively unchanged and allocated bytes reduced 88.06% | This commit |

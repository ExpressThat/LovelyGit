...
| Loose repository-ref refresh | 188.61 ms and 21.60 MB allocated for five reads of 500 loose refs | 160.15 ms and 1.84 MB allocated; normal ref files parse from a stack buffer and tag counting stays single-pass | Isolated disposable 500-ref benchmark; 14.95% faster and 91.48% fewer allocated bytes | This commit |

...
- Rendered ordinary stash-inspection file lists without a virtualizer, bounded maximum-list bootstrap and overscan, and built tracked/untracked inspection entries into one exact-size array while keeping every file reachable (current stash-inspection checkpoint).
